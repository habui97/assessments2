...
/* 
    ...
    'Welcome back, Andrew'
*/
const greatUser = username => `Welcome back, ${username}`
    console.log(greatUser('HaBui'));
...
function canWeDeliverTwo(zipCode){
    zipCode = String(deliveryAreaZipCodes)
...
*/
let deal1stTitle = '15% Off!';
let changeDiscount = deal1stTitle.replace('15','10');
...
let deal2ndDesc = '   This deal lasts until the end of March! ';
deal2ndDesc = deal2ndDesc.trim()
let changeMonth = deal2ndDesc.replace('March', 'April')
console.log(deal2ndDesc);
